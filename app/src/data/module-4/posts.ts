export const posts1 = [
    'Haz una lista con las 10 cosas que más agradeces hoy en tu vida:',
    '¿Cómo ha cambiado el curso tu forma de ver y experimentar la limitación?',
    'Comparte una experiencia en la que agradecieras la limitación:',
    ...
    '¿Cuándo fue que perdiste algo pero en cambio ganaste paz?'
]
...
export const posts2 = [
    ...
    '¿Cómo cambia tu misión desde la perspectiva espiritual (centrarla en el ser y dar)?',
    '¿Cuál es el legado o huella que al día de hoy has dejado al mundo?',
    '¿Cuál es tu mayor obstáculo o desafío en camino a cumplir tu misión espiritual y cómo lo superarás?',
