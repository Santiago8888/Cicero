export const posts1 = [
    'Tu crees en las vidas pasadas, ¿Por qué o a partir de qué evento?',
    '¿Hay algo en lo que notaras desde niñ@ que erás especialmente buena o bueno? ¿En qué?',
    'Durante el día de hoy escucha con atención a tu conciencia, ¿Qué te dice?',
    'El primer ciclo de Saturno es a los 7 años. Comparte una experiencia alrededor de esa edad que te haya hecho madurar.',
